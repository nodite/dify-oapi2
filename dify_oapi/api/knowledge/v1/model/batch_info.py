...
from .knowledge_types import DocumentStatus
...
class BatchInfoBuilder:
    ...
    def indexing_status(self, indexing_status: DocumentStatus) -> "BatchInfoBuilder":
        self._batch_info.indexing_status = indexing_status
        return self

    def processing_started_at(self, processing_started_at: datetime) -> "BatchInfoBuilder":
        self._batch_info.processing_started_at = processing_started_at
        return self

    def parsing_completed_at(self, parsing_completed_at: datetime) -> "BatchInfoBuilder":
        self._batch_info.parsing_completed_at = parsing_completed_at
        return self

    def cleaning_completed_at(self, cleaning_completed_at: datetime) -> "BatchInfoBuilder":
        self._batch_info.cleaning_completed_at = cleaning_completed_at
        return self

    def splitting_completed_at(self, splitting_completed_at: datetime) -> "BatchInfoBuilder":
        self._batch_info.splitting_completed_at = splitting_completed_at
        return self

    def completed_at(self, completed_at: datetime) -> "BatchInfoBuilder":
        self._batch_info.completed_at = completed_at
        return self

    def paused_at(self, paused_at: datetime) -> "BatchInfoBuilder":
    ...
    def stopped_at(self, stopped_at: datetime) -> "BatchInfoBuilder":
