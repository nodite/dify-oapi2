...
def update_child_chunk_sync() -> None:
    ...
    try:
        ...
        response = client.knowledge_base.v1.segment.update_child_chunk(request, request_option)
...
async def update_child_chunk_async() -> None:
    ...
    try:
        ...
        response = await client.knowledge_base.v1.segment.aupdate_child_chunk(request, request_option)
