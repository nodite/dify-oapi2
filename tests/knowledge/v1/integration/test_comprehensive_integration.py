...
# Dataset imports
from dify_oapi.api.knowledge.v1.model.dataset.create_request import (
    CreateRequest,
)
from dify_oapi.api.knowledge.v1.model.dataset.create_request_body import (
    CreateRequestBody,
)
from dify_oapi.api.knowledge.v1.model.dataset.create_response import (
    CreateResponse,
)
from dify_oapi.api.knowledge.v1.model.dataset.retrieve_request import (
    RetrieveRequest,
)
from dify_oapi.api.knowledge.v1.model.dataset.retrieve_request_body import (
    RetrieveRequestBody,
)
from dify_oapi.api.knowledge.v1.model.dataset.retrieve_response import (
    QueryInfo,
    RetrieveResponse,
)

# Metadata imports
from dify_oapi.api.knowledge.v1.model.metadata.create_request import (
    CreateRequest as CreateMetadataRequest,
)
from dify_oapi.api.knowledge.v1.model.metadata.create_request_body import (
    CreateRequestBody as CreateMetadataRequestBody,
)
from dify_oapi.api.knowledge.v1.model.metadata.create_response import (
    CreateResponse as CreateMetadataResponse,
)
from dify_oapi.api.knowledge.v1.model.metadata.list_request import (
    ListRequest as ListMetadataRequest,
)
from dify_oapi.api.knowledge.v1.model.metadata.list_response import (
    ListResponse as ListMetadataResponse,
)
from dify_oapi.api.knowledge.v1.model.metadata.metadata_info import MetadataInfo
from dify_oapi.api.knowledge.v1.model.tag.bind_request import BindRequest as BindTagsRequest
from dify_oapi.api.knowledge.v1.model.tag.bind_request_body import BindRequestBody as BindTagsRequestBody
from dify_oapi.api.knowledge.v1.model.tag.bind_response import BindResponse as BindTagsResponse

# Tag imports
from dify_oapi.api.knowledge.v1.model.tag.create_request import CreateRequest as CreateTagRequest
from dify_oapi.api.knowledge.v1.model.tag.create_request_body import CreateRequestBody as CreateTagRequestBody
from dify_oapi.api.knowledge.v1.model.tag.create_response import CreateResponse as CreateTagResponse
...
from dify_oapi.api.knowledge.v1.resource.metadata import Metadata
...
class TestComprehensiveIntegration:
    ...
    def test_complete_knowledge_setup_workflow(
        self,
    ...
    def test_advanced_retrieval_with_metadata_filtering(
        ...
        from dify_oapi.api.knowledge.v1.model.dataset.filter_condition import (
            FilterCondition,
        )
        from dify_oapi.api.knowledge.v1.model.dataset.metadata_filtering_conditions import (
            MetadataFilteringConditions,
        )
        from dify_oapi.api.knowledge.v1.model.dataset.retrieval_model import (
            RetrievalModel,
        )
    ...
    def test_resource_cleanup_workflow(
        ...
        from dify_oapi.api.knowledge.v1.model.dataset.delete_request import (
            DeleteRequest as DeleteDatasetRequest,
        )
        from dify_oapi.api.knowledge.v1.model.dataset.delete_response import (
            DeleteResponse as DeleteDatasetResponse,
        )
        from dify_oapi.api.knowledge.v1.model.metadata.delete_request import (
            DeleteRequest as DeleteMetadataRequest,
        )
        from dify_oapi.api.knowledge.v1.model.metadata.delete_response import (
            DeleteResponse as DeleteMetadataResponse,
        )
        from dify_oapi.api.knowledge.v1.model.tag.delete_request import (
            DeleteRequest as DeleteTagRequest,
        )
        from dify_oapi.api.knowledge.v1.model.tag.delete_request_body import (
            DeleteRequestBody as DeleteTagRequestBody,
        )
        from dify_oapi.api.knowledge.v1.model.tag.delete_response import (
            DeleteResponse as DeleteTagResponse,
        )
        from dify_oapi.api.knowledge.v1.model.tag.unbind_request import (
            UnbindRequest as UnbindTagRequest,
        )
        from dify_oapi.api.knowledge.v1.model.tag.unbind_request_body import (
            UnbindRequestBody as UnbindTagRequestBody,
        )
        from dify_oapi.api.knowledge.v1.model.tag.unbind_response import (
