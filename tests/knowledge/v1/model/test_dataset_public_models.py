...
from dify_oapi.api.knowledge.v1.model.dataset.external_knowledge_info import ExternalKnowledgeInfo
from dify_oapi.api.knowledge.v1.model.dataset.filter_condition import FilterCondition
from dify_oapi.api.knowledge.v1.model.dataset.metadata_filtering_conditions import MetadataFilteringConditions
...
class TestRetrievalModel:
    ...
    def test_field_validation(self) -> None:
        ...
        from dify_oapi.api.knowledge.v1.model.dataset.retrieval_model import KeywordSetting, VectorSetting, Weights
