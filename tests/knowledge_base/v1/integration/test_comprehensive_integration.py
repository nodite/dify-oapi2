...
class TestComprehensiveIntegration:
    ...
    def test_complete_knowledge_base_setup_workflow(
        ...
        responses = [
            ...
            RetrieveDatasetResponse(query=QueryInfo(content="comprehensive test query"), records=[]),
        ]
        ...
        create_dataset_request = (
            CreateDatasetRequest.builder().name("Comprehensive Dataset").description("Full workflow test").build()
        )
        ...
        create_metadata_request = (
            CreateMetadataRequest.builder().dataset_id(dataset_id).type("string").name("Document Category").build()
        )
        ...
        retrieve_request = (
            RetrieveDatasetRequest.builder().dataset_id(dataset_id).query("comprehensive test query").build()
        )
    ...
    async def test_complete_workflow_async(
        ...
        create_metadata_request = (
            CreateMetadataRequest.builder().dataset_id(dataset_id).type("number").name("Priority Level").build()
        )
    ...
    def test_cross_resource_dependencies(
        ...
        create_metadata_request = (
            CreateMetadataRequest.builder().dataset_id(dataset_id).type("string").name("Test Field").build()
        )
    ...
    def test_advanced_retrieval_with_metadata_filtering(
        ...
        filter_condition = (
            FilterCondition.builder().name("category").comparison_operator("is").value("technical").build()
        )
        filtering_conditions = (
            MetadataFilteringConditions.builder().logical_operator("and").conditions([filter_condition]).build()
        )
        ...
        retrieve_response = RetrieveDatasetResponse(query=QueryInfo(content="filtered query"), records=[])
