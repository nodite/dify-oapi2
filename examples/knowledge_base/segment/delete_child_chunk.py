...
def delete_child_chunk_sync() -> None:
    ...
    try:
        ...
        response = client.knowledge_base.v1.segment.delete_child_chunk(request, request_option)
...
async def delete_child_chunk_async() -> None:
    ...
    try:
        ...
        response = await client.knowledge_base.v1.segment.adelete_child_chunk(request, request_option)
