...
This example demonstrates streaming completion requests.
"""
...
def main():
    ...
    req_body = (
        ...
        .inputs({})
        .query("Write a concise explanation of machine learning. Please answer within 10 words. No thinking process.")
