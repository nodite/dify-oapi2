...
def list_child_chunks_sync() -> None:
    ...
    try:
        ...
        response = client.knowledge_base.v1.segment.list_child_chunks(request, request_option)
...
async def list_child_chunks_async() -> None:
    ...
    try:
        ...
        response = await client.knowledge_base.v1.segment.alist_child_chunks(request, request_option)
