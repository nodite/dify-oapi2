...
class TestSegmentExamplesValidation:
    ...
    def examples_dir(self) -> Path:
        ...
        return Path(__file__).parent.parent.parent.parent.parent / "examples" / "knowledge_base" / "segment"
    ...
    def test_create_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.create.return_value = mock_response
            mock_client.knowledge_base.v1.segment.acreate.return_value = mock_response
    ...
    def test_list_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.list.return_value = mock_response
            mock_client.knowledge_base.v1.segment.alist.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
    ...
    def test_get_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.get.return_value = mock_response
            mock_client.knowledge_base.v1.segment.aget.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
    ...
    def test_update_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.update.return_value = mock_response
            mock_client.knowledge_base.v1.segment.aupdate.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
    ...
    def test_delete_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.delete.return_value = mock_response
            mock_client.knowledge_base.v1.segment.adelete.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
    ...
    def test_create_child_chunk_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.create_child_chunk.return_value = mock_response
            mock_client.knowledge_base.v1.segment.acreate_child_chunk.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
    ...
    def test_list_child_chunks_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.list_child_chunks.return_value = mock_response
            mock_client.knowledge_base.v1.segment.alist_child_chunks.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
    ...
    def test_update_child_chunk_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.update_child_chunk.return_value = mock_response
            mock_client.knowledge_base.v1.segment.aupdate_child_chunk.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
    ...
    def test_delete_child_chunk_example_logic(self, examples_dir: Path) -> None:
        ...
        with patch("dify_oapi.client.Client") as mock_client_class:
            ...
            mock_client.knowledge_base.v1.segment.delete_child_chunk.return_value = mock_response
            mock_client.knowledge_base.v1.segment.adelete_child_chunk.return_value = mock_response
            mock_client_class.builder.return_value.domain.return_value.build.return_value = mock_client
