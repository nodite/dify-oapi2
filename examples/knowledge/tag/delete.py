...
def delete_tag_sync() -> None:
    ...
    try:
        ...
        list_response = client.knowledge.v1.tag.list(list_request, request_option)
        ...
        client.knowledge.v1.tag.delete(request, request_option)
...
async def delete_tag_async() -> None:
    ...
    try:
        ...
        list_request = ListRequest.builder().build()
        list_response = await client.knowledge.v1.tag.alist(list_request, request_option)
        ...
        request_body = DeleteRequestBody.builder().tag_id(tag_id).build()
        request = DeleteRequest.builder().request_body(request_body).build()
        await client.knowledge.v1.tag.adelete(request, request_option)
