...
class TestTagAPIIntegration:
    ...
    def test_tag_management_and_binding_workflow_sync(self, tag_resource: Tag, request_option: RequestOption, monkeypatch: Any) -> None:
        ...
        mock_execute.side_effect = [
            create_response, list_response, bind_response, 
            query_response, unbind_response, update_response, delete_response
        ]
    ...
    @pytest.mark.asyncio
    async def test_tag_management_workflow_async(self, tag_resource: Tag, request_option: RequestOption, monkeypatch: Any) -> None:
    ...
    def test_tag_binding_count_tracking(self, tag_resource: Tag, request_option: RequestOption, monkeypatch: Any) -> None:
    ...
    def test_global_vs_dataset_specific_operations(self, tag_resource: Tag, request_option: RequestOption, monkeypatch: Any) -> None:
        ...
        list_response = ListTagsResponse(data=[TagInfo(id=tag_id, name="Global Tag", type="knowledge", binding_count=0)])
        ...
        mock_execute = Mock()
        mock_execute.side_effect = [create_response, list_response, update_response, query_response, delete_response]
        monkeypatch.setattr("dify_oapi.core.http.transport.Transport.execute", mock_execute)
    ...
    def test_tag_name_validation_scenarios(self, tag_resource: Tag, request_option: RequestOption, monkeypatch: Any) -> None:
