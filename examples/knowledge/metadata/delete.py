...
def delete_metadata_sync() -> None:
    ...
    try:
        ...
        list_response = client.knowledge.v1.metadata.list(list_request, request_option)
        ...
        client.knowledge.v1.metadata.delete(request, request_option)
...
async def delete_metadata_async() -> None:
    ...
    try:
        ...
        list_request = ListRequest.builder().dataset_id(dataset_id).build()
        list_response = await client.knowledge.v1.metadata.alist(list_request, request_option)
        ...
        request = DeleteRequest.builder().dataset_id(dataset_id).metadata_id(metadata_id).build()
        await client.knowledge.v1.metadata.adelete(request, request_option)
