...
class UpdateRequestBuilder:
    def __init__(self):
        ...
        update_request.uri = "/v1/datasets/:dataset_id/metadata/:metadata_id"
    ...
    def metadata_id(self, metadata_id: str) -> UpdateRequestBuilder:
        self._update_request.metadata_id = metadata_id
        self._update_request.paths["metadata_id"] = metadata_id
        return self
